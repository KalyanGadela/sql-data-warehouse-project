...
Here we create stored procedure to store our bronze schema and when ever we want to call the stored procedure we will just execute the "EXEC bronze.load_bronze" 
===============================================================================
*/
